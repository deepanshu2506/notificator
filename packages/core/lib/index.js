...
})(exports.ChannelTypes || (exports.ChannelTypes = {}));
...
function HandlerFactory(handlerType) {
    switch (handlerType) {
        case exports.ChannelTypes.EMAIL:
            return new EmailHandler();
        case exports.ChannelTypes.SMS:
...
function evaluateTemplate(template, context, options) {
    ...
    var hbsTemplate = handlebars__namespace.compile(template, {
...
var MessageEngine = /** @class */ (function () {
    ...
    MessageEngine.prototype.getTemplateVarsFromPayload = function (template, payload) {
        return lodash.get(payload.templateVars, template.name);
    };
    MessageEngine.prototype.validatePayload = function (template, payload) {
        var channel = template.channel;
        switch (channel) {
            case exports.ChannelTypes.EMAIL:
                if (!(payload.email && validator__default["default"].isEmail(payload.email)))
